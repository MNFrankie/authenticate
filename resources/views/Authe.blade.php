...
<head>
    <meta charset="UTF-8">
    <title>Laravel Authenticate</title>
    <link rel="stylesheet" href="{{ URL::to('bootstrap/css/login.css') }}">
    <link rel="stylesheet" href="{{ URL::to('bootstrap/js/login.css') }}">
    <script type=" href{{ URL::to('bootstrap/js/login.js') }}">
